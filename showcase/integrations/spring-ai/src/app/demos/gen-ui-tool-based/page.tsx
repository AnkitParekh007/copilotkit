...
// Registers `generate_haiku` as a frontend tool via `useFrontendTool`.
// When the Spring AI agent calls `generate_haiku`, the matching React
// component (HaikuCard) renders inline in the chat. This follows the
// same pattern as all non-langgraph-python integrations.
