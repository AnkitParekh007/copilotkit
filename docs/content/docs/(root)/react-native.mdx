...
<Steps>
    ...
    <Step>
        ...
        All CopilotKit hooks work the same as on web. Here's a minimal chat screen using `useAgent` and `useCopilotKit`:
    ...
    <Step>
        ...
        Your React Native app is now connected to CopilotKit. All hooks from the web SDK work identically:
...
| `useAgent`, `useFrontendTool`, etc. | All hooks from `@copilotkit/react-core` |
